  ...
  return (
    <div className="h-14 flex items-center justify-between px-6 border-b border-white/10">
      ...
      <div className="flex items-center gap-4">
        <button className="rounded-full border border-white/12 px-4 py-2 text-sm text-white/80 hover:text-white">Login</button>
        <button className="rounded-full bg-[oklch(0.488_0.243_264.376)] text-white px-4 py-2 text-sm shadow-md shadow-[oklch(0.488_0.243_264.376)/30]">Create My Resume</button>
      </div>
    </div>
  );
}
